                    ...
                    <Col md={{ span: 4, offset: 4 }}>
                        <div className="login-box p-4 shadow">
                            <div className="text-center mb-4 text-light">
                                <h1 className="logo text-light">DevSpot</h1>
                            </div>
                            <h3 className="text-center text-light mb-3">Welcome Back!</h3>
                            <p className="text-center">Enter your details to log in</p>
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Button variant="primary" type="submit" className="w-100 login-btn justify-content-center align-items-center justify-items-center text-center">
                                    Log in
                                </Button>
